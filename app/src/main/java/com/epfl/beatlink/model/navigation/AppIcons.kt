            ...
            Builder(
                ...
                .apply {
                    ...
                    path(
                        ...
                        arcToRelative(4.5f, 4.5f, 0f,
                            isMoreThanHalf = true,
                            isPositiveArc = true,
                            dx1 = 0f,
                            dy1 = 9f
                        ) // Create the upper semicircle
                        arcToRelative(4.5f, 4.5f, 0f,
                            isMoreThanHalf = true,
                            isPositiveArc = true,
                            dx1 = 0f,
                            dy1 = -9f
                        ) // Create the lower semicircle

                        moveTo(15.5f, 14f) // Start point for the handle
                        lineTo(14.71f, 13.27f) // Draw line to the end of the handle
                        curveTo(
                            15.41f, 12.59f, 16f, 11.11f, 16f, 9.5f) // Draw curve for the top of the lens
