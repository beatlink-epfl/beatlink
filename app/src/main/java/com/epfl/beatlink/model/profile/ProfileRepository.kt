...
interface ProfileRepository {
  ...
  /**
   * Add a new user profile to Firestore, and add the corresponding username to the "usernames" collection.
   *
   * @param userId The unique identifier of the user.
  ...
  /**
   * Update a user's profile in Firestore, and update the corresponding username in the "usernames" collection if it changes.
   *
   * @param userId The unique identifier of the user.
  ...
  /**
   * Delete a user's profile from Firestore, and remove the corresponding username from the "usernames" collection.
   *
   * @param userId The unique identifier of the user.
