...
class SpotifyAuthViewModel(
    ...
    @VisibleForTesting
    internal val _accessToken = mutableStateOf<String?>(null)
    @VisibleForTesting
    internal val _refreshToken = mutableStateOf<String?>(null)
    @VisibleForTesting
    internal val _expiryTime = mutableStateOf<Long?>(null)
